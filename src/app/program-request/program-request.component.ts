...
@Component({
  ...
  styleUrls: ['./program-request.component.css']
})
export class ProgramRequestComponent implements OnInit {
  ...
  redrawTable() {
    ...
    var table = $("#ProgramsNew").DataTable({
      orderCellsTop: true,
      fixedHeader: true,
      bDestroy: true,
    ...
    var table = $("#ProgramsActive").DataTable({
      orderCellsTop: true,
      fixedHeader: true,
      bDestroy: true,
      initComplete: function () {
    ...
    var table = $("#ProgramsClosed").DataTable({
      orderCellsTop: true,
      fixedHeader: true,
      bDestroy: true,
      initComplete: function () {
  ...
  viewAppointmentDetails(appointment) {
    ...
    this.router.navigate(["/program-not-scheduled"]);
  }
