...
@Component({
  selector: 'app-go-sell-elements',
  templateUrl: './go-sell-elements.component.html',
  styleUrls: ['./go-sell-elements.component.css']
})
export class GoSellElementsComponent  {
  constructor(private goSellService: GoSellService) {}
...
goSell.config({
  ...
  openPaymentPage(): void {
    this.goSellService.openPaymentPage();
  }
}