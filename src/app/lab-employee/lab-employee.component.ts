...
@Component({
  ...
  styleUrls: ['./lab-employee.component.css']
})
export class LabEmployeeComponent implements OnInit {
  ...
  getPractiseUserList() {
    this._appService.getServiceProviderStaffList().subscribe((response: any) => {
      if (response.status == APIResponse.Success) {
        this.practiseUsers = PractiseUser.getServiceProviderStaffList(response.userList) ;
      } else {
