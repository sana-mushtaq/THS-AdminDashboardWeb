...
@Component({
  selector: 'app-insurance-not-scheduled',
  templateUrl: './insurance-not-scheduled.component.html',
  styleUrls: ['./insurance-not-scheduled.component.css']
})
export class InsuranceNotScheduledComponent implements OnInit {
  ...
  getAppointmentDetails(appointmentId: string) {
    ...
    this._appService.getInsuredAppointmentDetails(appointmentId).subscribe(
      (response: any) => {
        debugger;
        if (response.status == APIResponse.Success) {
          this.appointmentDetails = AppointmentDetails.initalizeInsuredAppointmentDetails(response);
