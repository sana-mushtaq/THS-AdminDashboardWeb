...
export class TestComponent implements OnInit {
  ...
  postLabTestToServer() {
    ...
    if (this.typeValidationForm.invalid) {
      ...
      params["availableForPatient"] = this.availForCustomerStatus;
  ...
  ngOnInit(): void {
    ...
    $('.active-testlist').addClass('active');
  }
  ...
  availForCustomer(event) {
    if(event.checked == true){
      this.availForCustomerStatus = 1;
    }
    if(event.checked == false){
      this.availForCustomerStatus = 0;
    }
  }
