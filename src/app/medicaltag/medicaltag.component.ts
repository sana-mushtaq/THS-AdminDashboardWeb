...
@Component({
  selector: 'app-medicaltag',
  templateUrl: './medicaltag.component.html',
  styleUrls: ['./medicaltag.component.css']
})
export class MedicaltagComponent implements OnInit {
  ...
  constructor(
    private _serviceTag: MedicaltagService,
