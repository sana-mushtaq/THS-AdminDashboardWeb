...
@Component({
  selector: 'app-insurance-appointments',
  templateUrl: './insurance-appointments.component.html',
  styleUrls: ['./insurance-appointments.component.css']
})
export class InsuranceAppointmentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    $(".appoint-insurance").addClass("active");
  ...
  redrawTable() {
    ...
    var table = $("#appointmentsNew").DataTable({
      "aaSorting": [],
      orderCellsTop: true,
      fixedHeader: true,
      bDestroy: true,
    ...
    var table = $("#appointmentsActive").DataTable({
      orderCellsTop: true,
      fixedHeader: true,
      bDestroy: true,
      initComplete: function () {
    ...
    var table = $("#appointmentsClosed").DataTable({
      orderCellsTop: true,
      fixedHeader: true,
      bDestroy: true,
      initComplete: function () {
  ...
  viewAppointmentDetails(appointment) {
    ...
    this.router.navigate(["/insurance-not-scheduled"]);
  }
