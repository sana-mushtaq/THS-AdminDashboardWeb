...
@Component({
  selector: 'app-program-not-scheduled',
  templateUrl: './program-not-scheduled.component.html',
  styleUrls: ['./program-not-scheduled.component.css']
})
export class ProgramNotScheduledComponent implements OnInit {
